...
#ifndef BOARD_KEPLER_H
#define BOARD_KEPLER_H
...
#define BOARD_NAME                  "Kepler iSNWO"
...
#define GPIOA_LED_BLUE             2U
#define GPIOA_LED_GREEN                3U
...
#define LINE_LED_BLUE              PAL_LINE(GPIOA, 2U)
#define LINE_LED_GREEN                 PAL_LINE(GPIOA, 3U)
...
#define LINE_MAIN_POWER                PAL_LINE(GPIOE, 10U)
 ...
 * PA1  - LED_RED              (alternate 11).
 * PA2  - LED_BLUE                 (alternate 11).
 * PA3  - LED_GREEN ADC123_IN3         (input pullup).
